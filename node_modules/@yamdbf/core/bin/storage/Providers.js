 ...
 */
Providers.PostgresProvider = (url) => SequelizeProvider_1.SequelizeProvider(url, SequelizeProvider_1.Dialect.Postgres);
/**
 * Factory method that returns a StorageProvider class for
 ...
 * @returns {StorageProviderConstructor}
 */
Providers.SQLiteProvider = (path) => SequelizeProvider_1.SequelizeProvider(path, SequelizeProvider_1.Dialect.SQLite);
/**
